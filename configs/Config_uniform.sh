...
RCUT=4.5                                      # cut-off radius beyond which Tree or FMM evaluations are stopped in TreePM / FMM-PM
NTAB=128                                     # size of short-range look-up table
#PLACEHIGHRESREGION=1                         # bitmask selecting the particle types that are used to define the location of a secondary PM mesh
...
#OUTPUT_COOLHEAT                              # per-particle CoolHeat accumulation & step summary
#COOLING_HOT_DEBUG                            # print limited details about very hot particles
...
#FOF_SECONDARY_LINK_TYPES=1+16                # bitmask, 2^type for the type(s) linked to nearest primary particle
