...
This folder contains some analysis and visualization scripts used
during CosmicGrain's development. A number were used in preparing the zoom itself and in selecting the target halo (Halo 569)
from the parent box, others are the ones that directly produced
