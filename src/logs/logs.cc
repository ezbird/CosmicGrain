      ...
      if(All.ComovingIntegrationOn)
        {
          ...
          fprintf(FdInfo, "\nSync-Point %d, Time: %g, Redshift: %g, CourantFac: %.3f, Systemstep: %g, Dloga: %g, Nsync-grv: %10llu, Nsync-hyd: %10llu\n",
                  All.NumCurrentTiStep, All.Time, z, All.CourantFac, All.TimeStep, log(All.Time) - log(All.Time - All.TimeStep),
                  All.GlobalNSynchronizedGravity, All.GlobalNSynchronizedHydro);
          printf("\n\nSync-Point %d, Time: %g, Redshift: %g, CourantFac: %.3f, Systemstep: %g, Dloga: %g, Nsync-grv: %10llu, Nsync-hyd: %10llu\n",
                 All.NumCurrentTiStep, All.Time, z, All.CourantFac, All.TimeStep, log(All.Time) - log(All.Time - All.TimeStep),
                 All.GlobalNSynchronizedGravity, All.GlobalNSynchronizedHydro);
          fprintf(FdTimebin, "\nSync-Point %d, Time: %g, Redshift: %g, CourantFac: %.3f, Systemstep: %g, Dloga: %g\n", All.NumCurrentTiStep, All.Time, z,
                  All.CourantFac, All.TimeStep, log(All.Time) - log(All.Time - All.TimeStep));
          myflush(FdInfo);
        }
      else
        {
          fprintf(FdInfo, "\nSync-Point %d, Time: %g, CourantFac: %.3f, Systemstep: %g, Nsync-grv: %10llu, Nsync-hyd: %10llu\n", All.NumCurrentTiStep,
                  All.Time, All.CourantFac, All.TimeStep, All.GlobalNSynchronizedGravity, All.GlobalNSynchronizedHydro);
          printf("\n\nSync-Point %d, Time: %g, CourantFac: %.3f, Systemstep: %g, Nsync-grv: %10llu, Nsync-hyd: %10llu\n", All.NumCurrentTiStep, All.Time,
                 All.CourantFac, All.TimeStep, All.GlobalNSynchronizedGravity, All.GlobalNSynchronizedHydro);
          fprintf(FdTimebin, "\nSync-Point %d, Time: %g, CourantFac: %.3f, Systemstep: %g\n", All.NumCurrentTiStep, All.Time, All.CourantFac, All.TimeStep);
          myflush(FdInfo);
        }
