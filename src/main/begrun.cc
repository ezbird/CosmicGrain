...
#ifdef FEEDBACK
  init_stellar_feedback(); // this just prints a message stating feedback diagnostics is enabled
#endif
...
void sim::set_units(void)
{
  ...
  mpi_printf("\n");
    ...
    mpi_printf("  Dust cooling:     %s\n", All.DustEnableCooling ? "ON" : "OFF");
    ...
    mpi_printf("  Coagulation:      %s\n", All.DustEnableCoagulation ? "ON" : "OFF");
