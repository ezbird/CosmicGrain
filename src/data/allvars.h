...
int SpatialHashDebugLevel;               // 0=off, 1=detailed output
...
#ifdef STARFORMATION
  #ifndef METALS
  #define METALS  // STARFORMATION automatically enables METALS
  #endif
#endif
  ...
  double MaxGasHsml;  /*!< Maximum gas smoothing length */
  double MinGasHsml;  /*!< Minimum gas smoothing length */
  ...
  double CourantFac_z20;
  double CourantFac_z10;
  double CourantFac_z2;
  double CourantFac_z0;
