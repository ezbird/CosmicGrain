...
void global_data_all_processes::register_parameters(void)
{
  ...
  add_param("CourantFac_z20", &CourantFac_z20, PARAM_DOUBLE, PARAM_CHANGEABLE);
  add_param("CourantFac_z10", &CourantFac_z10, PARAM_DOUBLE, PARAM_CHANGEABLE);
  add_param("CourantFac_z2", &CourantFac_z2, PARAM_DOUBLE, PARAM_CHANGEABLE);
  add_param("CourantFac_z0", &CourantFac_z0, PARAM_DOUBLE, PARAM_CHANGEABLE);
  ...
  add_param("MetalcoolFile", MetalcoolFile, PARAM_STRING, PARAM_CHANGEABLE);
#endif
